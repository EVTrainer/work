  ...
  if(options.data=="faces"):
    ...
    for i in range(numTraining):
      ...
      while(x in indexes):
        x=rnd.randint(0,451)
      indexes.append(x)
      rawTraining.append(rawTrainingData[x])
      rawTrainingLabel.append(trainingLabels[x])
    rawTrainingData=rawTraining
    trainingLabels=rawTrainingLabel
